...
def main():
    ...
    print("กำลังประมวลผลไฟล์ทั้งหมดในโฟลเดอร์ real_speech...")
    
    mode_choice = "1"  # ใช้โหมด 1 เป็นค่าเริ่มต้น
    
    # สร้างโฟลเดอร์ real_speech2 หากไม่มี
    output_folder = "real_speech2"
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)
        print(f"สร้างโฟลเดอร์ {output_folder} แล้ว")
    
    # ค้นหาไฟล์เสียงทั้งหมดในโฟลเดอร์ real_speech
    source_folder = "real_speech"
    ...
    if not audio_files:
        print(f"ไม่พบไฟล์เสียงในโฟลเดอร์ {source_folder}")
    ...
    for i, audio_file in enumerate(audio_files, 1):
        ...
        try:
            ...
            run_batch_analysis(analyzer, audio_file, output_folder)
    ...
    print(f"ภาพกราฟทั้งหมดถูกบันทึกในโฟลเดอร์: {output_folder}")
    print(f"{'='*60}")
